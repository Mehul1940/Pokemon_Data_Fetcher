...
document.getElementById("fetchData").addEventListener("click", async () => {
  ...
  try {
    ...
    evolutionChain.innerHTML = evolutions
      .map(
        (evolution) =>
          `<li class="list-group-item data-item">${evolution.name} → ${evolution.reason}</li>`
      )
      .join("");
    ...
    weaknessesList.innerHTML = pokemon.weaknesses
      .map(
        (weakness) => `<li class="list-group-item data-item">${weakness}</li>`
      )
      .join("");
    ...
    typeAdvantagesList.innerHTML = pokemon.typeAdvantages
      .map(
        (advantage) => `<li class="list-group-item data-item">${advantage}</li>`
      )
      .join("");
    ...
    typeDisadvantagesList.innerHTML = pokemon.typeDisadvantages
      .map(
        (disadvantage) =>
          `<li class="list-group-item data-item">${disadvantage}</li>`
      )
      .join("");
